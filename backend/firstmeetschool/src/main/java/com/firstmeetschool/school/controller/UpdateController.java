...
public class UpdateController {
    ...
    @RequestMapping(value = "/{usrId}", method = RequestMethod.PUT, produces = "text/plain;charset=UTF-8")
    ...
    @RequestParam("usrEducation") String usrEducation, @RequestParam("isStudent") String isStudent){
        ...
        int temp = updateService.updateUserInfo(usrWechat, usrName, usrTelephone, usrHeight, usrAge,
